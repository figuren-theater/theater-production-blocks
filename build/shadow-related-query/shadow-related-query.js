...
"use strict";
/*!*******************************************************************!*\
  !*** ./src/block-editor/variations/shadow-related-query/index.js ***!
  \*******************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/element */ "@wordpress/element");
/* harmony import */ var _wordpress_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__);
...
const productionShadowRelatedQuery = {
  ...
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Production Related', 'theater-production-blocks'),
  ...
  attributes: {
    ...
    query: {
      ...
      //      search: 	"",
      exclude: [],
      // or pass multiple values in an array, e.g. [ 1, 9098 ]
      sticky: "exclude",
      inherit: false,
      taxQuery: {
    ...
    // align:		"wide",
    className: "wpt-production-shadow-related-query",
    // important for isActive callback fn
    customClassName: false
  },
  innerBlocks: [['core/post-template', {}, [['core/cover', {
  ...
  // scope: [ 'inserter'],
  isActive: blockAttributes => 'wpt-production-shadow-related-query' === blockAttributes.className,
  usesContext: ['core/post-template/postId']
};
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_2__.registerBlockVariation)('core/query', productionShadowRelatedQuery);
const productionShadowRelatedQueryEngine = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_5__.createHigherOrderComponent)(BlockListBlock => {
  return props => {
    if ('wpt-production-shadow-related-query' !== props.attributes.className) return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockListBlock, {
      ...props
    });
    if ('core/query' !== props.name) return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockListBlock, {
      ...props
    });
    ...
    const currentPost = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.select)('core/editor').getCurrentPost();
    ...
    if (PT_PRODUCTION === currentPost.type) {
       ...
       */
      shadowedProductions = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
        const {
    ...
    if (0 === shadowedProductions.length) return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(BlockListBlock, {
      ...props
    });

    // Use Lodash's assign to gracefully handle if attributes are undefined
    // props.attributes.query = assign( props.attributes.query, {
    lodash_assign__WEBPACK_IMPORTED_MODULE_1___default()(props.attributes.query, {
...
(0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_6__.addFilter)('editor.BlockListBlock', 'wpt/production-shadow-related-query', productionShadowRelatedQueryEngine);
...
/******/ })()
;
//# sourceMappingURL=shadow-related-query.js.map