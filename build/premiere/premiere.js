...
function edit(_ref) {
  ...
  const settings = (0,_wordpress_date__WEBPACK_IMPORTED_MODULE_6__.__experimentalGetSettings)();
  ...
  const metaFieldValue = meta[_utils_constants_js__WEBPACK_IMPORTED_MODULE_8__.PREMIERE_META];
  const updateMetaValue = newValue => {
    setMeta({
      ...meta,
      [_utils_constants_js__WEBPACK_IMPORTED_MODULE_8__.PREMIERE_META]: newValue
    });
  };
