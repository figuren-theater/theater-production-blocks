...
const productionShadowRelatedQuery = {
	...
	description: 	__( 'Shows content related to the production, that is connected to this post. ', 'theater-production-blocks' ),
	keywords:		[
...
const productionShadowRelatedQueryEngine = createHigherOrderComponent(BlockListBlock => {
  return (props) => {
	...
	if ('wpt-production-shadow-related-query' !== props.attributes.className )
